function R = SLSC_1rec_position_as_source_dll(rf_data,source_locations,image_coordinates,c,fsamp,m,w,Nx,Ny,Nz)
% USAGE: 
% 
%   R = SLSC_1rec_position_as_source_dll(rf_data,source_locations,image_coordinates,c,fsamp,Nx,Ny,Nz)
% 
% INPUTS:
...
[~,~,~,R] = calllib('ImgAlg','SLSC_1rec_as_src',rf_data,source_locations,image_coordinates,c,fsamp,Nsrc,Nt,Nimg,m,w,R);
