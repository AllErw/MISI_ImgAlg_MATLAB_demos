function img = DnS_1rec_free_position_dll(rf_data,source_locations,receiver_locations,image_coordinates,c,fsamp,Nx,Ny,Nz)
% USAGE: 
% 
%   img = DnS_1rec_free_position_dll(rf_data,source_locations,receiver_locations,image_coordinates,c,fsamp,Nx,Ny,Nz)
% 
% INPUTS:
...
[~,~,~,~,img] = calllib('ImgAlg','DnS_1rec_free_pos',rf_data,source_locations,receiver_locations,image_coordinates,c,fsamp,Nsrc,Nt,Nimg,zeros(Nimg,1));
