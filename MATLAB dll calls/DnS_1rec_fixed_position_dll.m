function img = DnS_1rec_fixed_position_dll(rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,Nx,Ny,Nz)
% USAGE: 
% 
...
[~,~,~,~,img] = calllib('ImgAlg','DnS_1rec_fixed_pos',rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,Nsrc,Nt,Nimg,zeros(Nimg,1));
