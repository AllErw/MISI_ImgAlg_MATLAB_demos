function R = SLSC_1rec_fixed_position_dll(rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,m,w,Nx,Ny,Nz)
% USAGE: 
% 
%   img = SLSC_1rec_fixed_position_dll(rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,Nx,Ny,Nz)
% 
% INPUTS:
...
[~,~,~,~,R] = calllib('ImgAlg','SLSC_1rec_fixed_pos',rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,Nsrc,Nt,Nimg,m,w,R);
