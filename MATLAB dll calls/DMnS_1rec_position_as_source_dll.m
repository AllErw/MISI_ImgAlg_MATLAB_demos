function img = DMnS_1rec_position_as_source_dll(rf_data,source_locations,image_coordinates,c,fsamp,Nx,Ny,Nz)
% USAGE: 
% 
...
[~,~,~,img] = calllib('ImgAlg','DMnS_1rec_as_src',rf_data,source_locations,image_coordinates,c,fsamp,Nsrc,Nt,Nimg,img);
